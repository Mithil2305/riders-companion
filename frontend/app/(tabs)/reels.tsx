...
export default function ReelsScreen() {
  ...
  const [likedReelIds, setLikedReelIds] = React.useState<Record<string, boolean>>({});
  ...
  const renderReel = React.useCallback(
    ({ item }: { item: ReelItem }) => {
      ...
      <View style={styles.reelContainer}>
        <Image resizeMode="cover" source={{ uri: item.media }} style={styles.media} />
        ...
        <View style={styles.topRightHint}>
          <Ionicons color={colors.primary} name="reload" size={metrics.icon.md} />
        </View>
        ...
        <View style={styles.rightRail}>
          ...
          <View style={styles.actionItem}>
            <View style={styles.actionIconWrap}>
              <Ionicons color={colors.textInverse} name="chatbubble" size={metrics.icon.md} />
            </View>
          ...
          <View style={styles.actionItem}>
            <View style={styles.actionIconWrap}>
              <Ionicons color={colors.textInverse} name="paper-plane" size={metrics.icon.md} />
            </View>
        ...
        <View style={styles.bottomMeta}>
          ...
          <View style={styles.musicRow}>
            <Ionicons color={colors.textInverse} name="musical-notes-outline" size={metrics.icon.sm} />
